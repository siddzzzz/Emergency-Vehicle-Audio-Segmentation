    ...
    def process_stream(self, mix_waveform, device="cpu"):
        ...
        with torch.no_grad():
            for i in range(num_hops):
                ...
                mask, pred_mag = self.model(win_mag_input)
                ...
                # Clip confidence between 0.0 and 1.0
                ...
                # Trim or pad estimated window to exact window_size
        ...
        if detected_intervals:
            ...
            traffic_action = f"[EMERGENCY PRIORITY ACTIVATED] Siren Detected in interval(s) [{interval_str}]. OVERRIDE SIGNAL TO GREEN FOR APPROACHING EMERGENCY VEHICLE!"
        else:
